const URL = "https://braccoi.pythonanywhere.com/"
        ...
        function obtenerProductos() {
            fetch(URL + 'amigus') // Realiza una solicitud GET al servidor y obtener la lista de productos.
                .then(response => {
                ...
                .catch(error => {
                    ...
                    alert('Error al obtener los Amigurumis.');
                });
        }
        ...
        function eliminarProducto(codigo) {
            ...
            if (confirm('¿Estás seguro de que quieres eliminar este Amigurumi?')) {
                fetch(URL + `amigus/${codigo}`, { method: 'DELETE' })
                    .then(response => {
                        if (response.ok) {
